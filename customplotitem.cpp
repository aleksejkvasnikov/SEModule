...
void CustomPlotItem::initCustomPlot(QVector<double> x, QVector<double> y)
{
    ...
    setupQuadraticDemo( m_CustomPlot, x, y );
...
void CustomPlotItem::setupQuadraticDemo( QCustomPlot* customPlot,QVector<double> x, QVector<double> y)
{
...
/*surfaceModelList *CustomPlotItem::list() const
{
    return mList;
}

void CustomPlotItem::setList(surfaceModelList *list)
{
  mList = list;
}
*/
